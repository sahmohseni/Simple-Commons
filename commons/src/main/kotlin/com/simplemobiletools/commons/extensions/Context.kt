...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.devgroups.callmanager") && !packageName.startsWith("com.devgroups.callmanager")) {
        true
    } else if ((packageName.startsWith("com.devgroups.callmanager") || packageName.startsWith("com.devgroups.callmanager")) && isQPlus()) {
